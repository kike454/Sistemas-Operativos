...
void main()
{
	...
	{
		variable++;
		printf("Soy el proceso P1 con PID %d ,mi padre cuyo PPID es %d y el valor de la variable es %d \n", getpid(),getppid(),variable);

	}else if(fork()==0)
	{
		variable++;
		printf("Soy el proceso P2 con PID %d, mi padre cuyo PPID es %d  y el valor de la varibale es %d \n ", getpid(),getppid(),variable);
	

	}else if(fork()==0)
	{
		variable++;
		printf("Soy el proceso P3 con PID %d, mi padre cuyo PPID es %d y el valor de la variable es %d \n", getpid(),getppid(),variable);
		if(fork()==0){
